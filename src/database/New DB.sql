...
BEGIN 
	...
	SELECT RESPUESTA INTO RESPUESTA_V  FROM ACTIVIDAD A WHERE A.ID = NEW.ACTIVIDAD;
...
BEGIN 
	...
	DECLARE RESPUESTA VARCHAR(200) DEFAULT NEW.SELECCION;
	DECLARE RESPUESTA_V VARCHAR (200); 
	SELECT R.RESPUESTA INTO RESPUESTA_V  FROM ACTIVIDAD A  WHERE A.ID = NEW.ACTIVIDAD;
